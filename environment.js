...
readJSONFile("JSON/SVG_Y_Axis.json", function (error, data) {
    if (error) {
        console.log("Error reading JSON file:", error);
    } else {
...
readJSONFile("JSON/OperationLines.json", function (error, data) {
    if (error) {
        console.log("Error reading JSON file:", error);
    } else {
        OperationLines = data;
...
readJSONFile("JSON/CarKind.json", function (error, data) {
    if (error) {
        console.log("Error reading JSON file:", error);
    } else {
        CarKind = data;
